...
class ChineseWritingApp:
    ...
    def get_random_word_and_sentence(self):
        ...
        Returns:
            tuple: A tuple containing the generated sentence and word details (English meaning, Chinese character, and pinyin).
        """
...
def create_ui():
    ...
    # Custom CSS styling for larger text outputs (using Simplified Chinese font)
    custom_css = """
