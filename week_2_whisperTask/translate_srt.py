...
translator = GoogleTranslator(source="zh-CN", target="en")  # Use 'zh-CN' instead of 'zh'

# Read the Chinese subtitle file
with open("subtitles_zh.srt", "r", encoding="utf-8") as f:
